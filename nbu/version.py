...
ENDPOINTS = {
    ...
    "asset_workloads": "/asset-service/workloads",
    "asset_workload_assets": "/asset-service/workloads/{workload}/assets",
    "asset_workload_asset": "/asset-service/workloads/{workload}/assets/{asset_id}",
    "asset_workload_schemas": "/asset-service/workloads/{workload}/schemas",
    "health": "/admin/health",
